  ...
  return (
    <div className="bg-slate-100 min-h-screen">
      <div className="flex flex-col md:flex-row">
        {/* Left Sidebar */}
        <div className="w-full md:w-1/4 p-4 md:p-6 sticky top-0 space-y-4">
          <h3 className="font-bold text-xl text-teal-600">Categories</h3>
          <ul className="space-y-2">
            <li className="text-gray-700 hover:text-teal-500 cursor-pointer">
              Historical and Cultural Cities
        ...
        <div className="w-full md:w-1/4 p-4 md:p-6">
          <div className="space-y-4">
            <h3 className="font-bold text-xl text-teal-600">Discover Trends</h3>
            <ul className="space-y-2">
              <li className="text-orange-700 hover:text-teal-500 cursor-pointer">
                <a
                  target="_blank"
        ...
        <div className="flex-grow">
          ...
          <div className="py-4">
            {isEditing ? (
              ...
              <>
                <h5 className="font-semibold text-lg">{editedTitle}</h5>
                <p className="text-gray-700">{editedContent}</p>
                {image && (
                  <img
                    src={image}
                    alt="Post"
                    className="w-full h-auto mt-2 rounded-lg object-cover"
                  />
                )}
              </>
            )}
