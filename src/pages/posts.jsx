  ...
  return (
    <div className="bg-slate-100 min-h-screen ">
      <div className="flex flex-col md:flex-row">
        {/* Left Sidebar */}
        <div className="md:w-1/4 p-4 md:p-6">
        ...
        <div className="flex-grow p-4 md:p-6 max-w-3xl mx-auto w-full">
          ...
          {currentUser && <Addpost className="w-full mb-4" />}
          {posts.map((post) => (
  ...
  return (
    <div className="bg-white p-4 rounded mb-7 shadow relative transition-transform transform hover:scale-105 hover:shadow-2xl duration-300 max-w-3xl mx-auto">
      <div className="flex items-start">
        ...
        <div className="flex-grow">
          <div className="flex items-center justify-between pb-6 border-b-2 border-b-slate-200">
            <div>
              ...
              <span className="text-gray-500 ml-2 text-sm md:text-base">• {formattedTime}</span>
            </div>
            {isLoggedIn && (
          ...
          <div className="mt-4">
            {isEditing ? (
              ...
              <>
                <h3 className="font-bold text-teal-600 text-xl md:text-2xl">{title}</h3>
                <p className="mt-1 text-gray-800 text-sm md:text-base">{content}</p>
              </>
            )}
            {image && (
              <img
        ...
        {isLoggedIn ? (
            <div className="flex items-center text-sm justify-around mt-4 pt-2 border-t-2 border-t-slate-200">
