...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col lg:flex-row">
      {/* Left Sidebar */}
      <aside className="bg-white border-r w-full lg:w-1/5 h-auto lg:h-screen lg:sticky lg:top-0">
        <div className="p-4">
      ...
      {/* Main Content */}
      <main className="flex-grow w-full lg:w-1/2 bg-gray-50">
      ...
      {/* Right Sidebar */}
      <aside className="w-full lg:w-1/4 bg-gray-50 p-4 border-l lg:border-l-0">
